...
export default function TrueOrFalse({ question, onAnswer }: TrueOrFalseProps) {
  ...
  return (
    <section className="mt-6 rounded-lg border border-gray-700 bg-gray-800 p-6 text-white">
      ...
      <p className="mt-2 text-sm text-gray-400">Choisissez l'option qui vous semble correcte.</p>
